...
<section id="about" class="py-16 px-4 sm:px-6 lg:px-8 bg-dark-300 mt-16 relative" data-lazy-load role="region" aria-labelledby="about-heading">
    ...
    <div class="container mx-auto max-w-5xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="order-1 md:order-2 flex justify-center animate-fade-in animation-delay-200">
                <div class="glass-card p-6 rounded-xl border border-zinc-700/30 hover:border-blue-500 hover:border-2 hover:bg-blue-500/10 hover:translate-y-[-5px] transition-all duration-300 shadow-md hover:shadow-blue-500/20" tabindex="0" role="img" aria-labelledby="about-image-description">
