...
<section id="contact" class="py-16 px-4 sm:px-6 lg:px-8 bg-dark-200 contact-section">
    <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            ?>
            <a href="<?php echo esc_attr($item['url']); ?>" <?php echo $item['target'] ? 'target="' . esc_attr($item['target']) . '"' : ''; ?> <?php echo $item['rel'] ? 'rel="' . esc_attr($item['rel']) . '"' : ''; ?> class="glass-card p-6" data-lazy-load>
